...
reg0 = lm.LinearRegression(fit_intercept=True, copy_X=True, n_jobs=None)
...
reg1 = lm.LinearRegression(fit_intercept=True, copy_X=True, n_jobs=None)
...
regC = lm.LinearRegression(fit_intercept=True, copy_X=True, n_jobs=None)
fitC = regC.fit(x, y)
